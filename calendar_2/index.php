...
<body>
    ...
    <nav>
        <div class="nav-wrapper" style="background-color: #424242; display: flex; align-items: center; font-weight: 400; font-size: 1.6rem;padding: 1rem;">

            <a href="../menu/menu.php" onclick="history.back();">Voltar</a>
