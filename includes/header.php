 ...
 <body>
   ...
   <div class="wrapper">
     <div class="user" style="position: fixed; right: 0; top: 0; z-index: 100; background-color: #424242; color: white;display: flex; align-items: center;border-radius: .2rem;">
       <p style="padding: .8rem 1.2rem .5rem .5rem;">Nome: <?php echo $nomeUser; ?></p>
       <p style="padding: .8rem 1.2rem .5rem .5rem;">Usuário: <?php echo $userName; ?></p>
       <p style="padding-right:.5rem;">Permissão: <?php echo $tipoUser; ?></p>
       <a href="http://localhost/tcc/login/" style="padding-right:.5rem;color: white; font-weight: 600; margin-left: .8rem;">Sair</a>
     ...
     <div class="sidebar">
       ...
       <ul>
         ...
         <div class="menu-departamento" style="color: white;">
           <li class=""><a class=' fas fa-user' href='../gerenciar_cliente'> Clientes</a></li>
