...
?>
    ...
    <div class="col container">
        ...
        <div class="div-sel" id="div1">
            ...
            <form action="">
                ...
                <div class="div1 intro" style="padding: 15px;background-color: #263238 ;color:white; margin-bottom: 2rem; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                    ...
                    <?php
                    echo '<p style="padding: 4px;">' . $observacao . '</p>';
                    ?>
                </div>
                ...
                ?>
                            <div class="div1 intro" style="padding: 15px;background-color: #263238 ;color:white;display: flex; align-items: center; justify-content: center;">
                                <div style="width: 85%;">
                                    <?php
                                    echo $dados_obs['observacao'];    ?>
                                </div>
                                <?php if (!($tipoUser == 'atendente')) { ?>
                                    <div>
                                        <a href="#modal1<?php echo $dados_obs['id']; ?>" class="btn red modal-trigger"><i class="material-icons">delete</i></a>
                                    </div>
                                <?php } ?>
                            </div>
        ...
        <a class="btn teal darken-4" onclick="history.back();">Voltar</a>
